...
```{r CLT figure, echo=FALSE, out.width='75%', fig.cap='Normal distribution with marked area', fig.align='center'}

knitr::include_graphics(here::here('assets','CLT_graph.png'))
```
