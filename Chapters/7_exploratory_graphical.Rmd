...
```{r kernel-density, echo=FALSE, out.width='100%', fig.cap='Examples of well-known kernels $K$', fig.align='center'}
knitr::include_graphics(here::here('assets/kernel_density.png'))
```
...
library(UsingR)
```
```{r, out.width = "100%", out.height="120%"}
